...
jQuery.Huifold = function(obj,obj_c,speed,obj_type,Event){
		$("#RecommendedProblemsMenu").removeClass("selected");
		if($(RecommendedProblemsMenu).find("b")){
		$("#RecommendedProblemsMenu").find("b").html("+");
		}
		$("#RecommendedProblemsMenu").next().slideDown(speed).end().addClass("selected");
		if($("#RecommendedProblemsMenu").find("b")){
		$("#RecommendedProblemsMenu").find("b").html("-");
		}
	if(obj_type == 2){
	...
	$(obj).on(Event,function(){
		if($(this).next().is(":visible")){
			if(obj_type == 2){
				...
				if(this.id!="RecommendedProblemsMenu")
				{
			...
			if(obj_type == 3){
				...
				else if(this.id!="RecommendedProblemsMenu")
				{
